...
public class Int101Homework02 {
    ...
    static void work01Utilitor() {
        ...
        System.out.println(Utilitor.testString("PJ"));
        System.out.println("---- 1.3 ----");
        System.out.println(Utilitor.computeIsbn10(974472362));
        System.out.println("---- 1.4 ----");
        System.out.println(Utilitor.testPositive(320.5));
    ...
    static void work02Person() {
        Person p1 = new Person("Sirawich", "Phasuk");
        Person p2 = new Person("Suchai", "Chaiwong");
        Person p3 = new Person("Rubby", "Raksiam");
        ...
        p2.setFirstname("MyGod");
        p2.setLastname("Malokov");
